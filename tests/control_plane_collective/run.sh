...
grep -q '"task_count": 4' "$OUTPUT_DIR/orchestrator.log"
grep -q '"allreduce0": "COMPLETED"' "$OUTPUT_DIR/orchestrator.log"
python3 "$CASE_DIR/verify.py" "$CASE_DIR"
echo "control-plane collective test passed"
